 ...
 * </copyright>
 *
 * $Id: EditingSwitch.java,v 1.1 2010/09/01 05:56:00 alena Exp $
 */
...
public class EditingSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EditingPackage.COMPLETE: {
				Complete complete = (Complete)theEObject;
				T result = caseComplete(complete);
				if (result == null) result = caseCommand(complete);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EditingPackage.PROPOSAL: {
				Proposal proposal = (Proposal)theEObject;
				T result = caseProposal(proposal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EditingPackage.DESCRIPTION: {
				Description description = (Description)theEObject;
				T result = caseDescription(description);
				if (result == null) result = caseCommand(description);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EditingPackage.DOC: {
