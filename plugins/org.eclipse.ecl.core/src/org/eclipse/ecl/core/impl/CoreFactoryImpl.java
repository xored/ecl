...
public class CoreFactoryImpl extends EFactoryImpl implements CoreFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CorePackage.ECL_JAVA_OBJECT: return createEclJavaObject();
			default:
	 ...
	 * @generated
	 */
	public EclJavaObject createEclJavaObject() {
		EclJavaObjectImpl eclJavaObject = new EclJavaObjectImpl();
		return eclJavaObject;
	}
