        ...
        if (working != null) {
            ...
            do {
                ...
                if (working.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    Element replaced = c.getNamespaceHandler().replaceElement(element, doc);
                    if (replaced != null) {
                        parent.replaceChild(replaced, element);
                        sharedContext.addReplacedElement(replaced, element);
                        working = replaced;
                        element = replaced;
                    }
