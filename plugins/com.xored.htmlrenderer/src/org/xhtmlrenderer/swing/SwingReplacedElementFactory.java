...
public class SwingReplacedElementFactory implements ReplacedElementFactory {
    ...
    public ReplacedElement createReplacedElement(
        ...
        NamespaceHandler nsh = context.getNamespaceHandler();
        ...
        if (nsh.isImageElement(e)) {
            return replaceImage(uac, context, e, cssWidth, cssHeight);
        } else if (nsh instanceof XhtmlNamespaceHandler) {
            //form components
            ...
            cc = form.addComponent(context.getSharedContext().getOriginalElement(e));
        }
        if (cc == null) {
            return null;
