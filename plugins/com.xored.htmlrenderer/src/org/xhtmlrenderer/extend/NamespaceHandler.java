...
public interface NamespaceHandler {
    ...
    /**
     * This method can be used to replace an element with another. The
     * element should NOT be modified. Instead, it should be cloned or a new
     * element should be created and the result should be returned.
     * 
     * @param e the original element (should NOT be modified)
     * @param doc the document to create new nodes
     * @return the replacing element or null if no replacing action should be taken
     */
    Element replaceElement(Element e, Document doc);
}
