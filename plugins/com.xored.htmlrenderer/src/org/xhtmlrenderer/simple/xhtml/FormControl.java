...
public interface FormControl {
    ...
    /**
     * Construct the children of element e to provide a good-looking
     * representation of the control under all implementations.
     * 
     * @param e the original element (should NOT be modified)
     * @param doc document for node creation
     * @param result resulting element (add children here)
     * @return
     */
    void constructDOM(Element e, Document doc, Element result);
}
