...
public class XhtmlNamespaceHandler extends XhtmlCssOnlyNamespaceHandler {
    ...
    public Element replaceElement(Element e, Document doc) {
        // handle form elements
        FormControl control =  XhtmlForm.createControl(null, e);
        if (control != null) {
            Element replaced = (Element) e.cloneNode(false);
            control.constructDOM(e, doc, replaced);
            return replaced;
        } else {
            return super.replaceElement(e, doc);
        }
    }
