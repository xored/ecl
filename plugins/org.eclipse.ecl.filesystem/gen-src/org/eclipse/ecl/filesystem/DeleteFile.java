 ...
 * <ul>
 *   <li>{@link org.eclipse.ecl.filesystem.DeleteFile#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.ecl.filesystem.FilesystemPackage#getDeleteFile()
...
public interface DeleteFile extends Command {
	 ...
	 * @see #setUri(String)
	 * @see org.eclipse.ecl.filesystem.FilesystemPackage#getDeleteFile_Uri()
	 * @model required="true"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ecl.filesystem.DeleteFile#getUri <em>Uri</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
