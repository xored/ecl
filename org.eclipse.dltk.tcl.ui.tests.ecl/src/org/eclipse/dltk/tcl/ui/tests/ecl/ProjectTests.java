...
public class ProjectTests extends EclSWTTestsRunner {
	public static final String PROJECT_SCRIPTS_ROOT = "/scripts/projectTests";

	public ProjectTests(String name, String content) {
		super(name, content);
	}
