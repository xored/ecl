 ...
 * </copyright>
 *
 * $Id: SetTextImpl.java,v 1.1 2010/08/02 09:24:14 andrey Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.ecl.swt.impl.SetTextImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetTextImpl extends CommandImpl implements SetText {
	...
	protected EClass eStaticClass() {
		return SwtPackage.Literals.SET_TEXT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SwtPackage.SET_TEXT__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SwtPackage.SET_TEXT__TEXT:
				return getText();
		}
