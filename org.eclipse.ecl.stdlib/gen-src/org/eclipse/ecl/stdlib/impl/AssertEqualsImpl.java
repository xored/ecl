 ...
 * </copyright>
 *
 * $Id: AssertEqualsImpl.java,v 1.1 2010/08/02 09:24:20 andrey Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.ecl.stdlib.impl.AssertEqualsImpl#getExpected <em>Expected</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AssertEqualsImpl extends CommandImpl implements AssertEquals {
	/**
	...
	protected EClass eStaticClass() {
		return StandartLibraryPackage.Literals.ASSERT_EQUALS;
	}
	...
	public void setExpected(String newExpected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StandartLibraryPackage.ASSERT_EQUALS__EXPECTED, oldExpected, expected));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StandartLibraryPackage.ASSERT_EQUALS__EXPECTED:
				return getExpected();
		}
